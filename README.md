...
update time: **2018-09-03 22:43:06**
...
红黑二叉查找树(后用‘红黑树’)基本思想是标准的二叉查找树（完全由2-结点构成）和一些额外的信息来表示2-两个2-结点连接起来构成一个3-结点，黑链接则是2-3树中的普通链接
...
对于任意的2-3树，只要对接点进行转换，我们都可以立即派生出一棵对应的二叉查找树。我们将这种方式表示2-3树的二叉查找树成为红黑树
